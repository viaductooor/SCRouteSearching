package org.lab1505.fordFulkerson;
...
public class FordFulkerson {
    ...
    public static void main(String[] args) {
        ...
        flowNetwork.addEdge(new FlowEdge(0,1,1,0));
        flowNetwork.addEdge(new FlowEdge(0,2,1,0));
        flowNetwork.addEdge(new FlowEdge(1,4,1,0));
        flowNetwork.addEdge(new FlowEdge(1,5,1,0));
        flowNetwork.addEdge(new FlowEdge(2,3,1,0));
        flowNetwork.addEdge(new FlowEdge(5,2,1,0));
        flowNetwork.addEdge(new FlowEdge(3,6,1,0));
        flowNetwork.addEdge(new FlowEdge(4,6,1,0));
        flowNetwork.addEdge(new FlowEdge(5,6,1,0));
        StdOut.println(flowNetwork.toString());

        FordFulkerson fk = new FordFulkerson(flowNetwork,0,6);
        StdOut.println("Maximum flow: "+fk.value());
        for(int i=0;i<7;i++){
            StdOut.println(i+": "+fk.inCut(i));
        }


        // compute maximum flow and minimum cut
        StdOut.println("Max flow from " + 0 + " to " + 6);
